...
def convert_POSIX_features_to_percentages(df, remove_dual=False):
    ...
    #df.POSIX_BYTES_WRITTEN = total_bytes - df.POSIX_BYTES_READ
...
def extracting_log(path):
    log_features = ['POSIX_OPENS', 'POSIX_SEEKS', 'POSIX_STATS', 'POSIX_MMAPS', 'POSIX_FSYNCS', 'POSIX_MODE',
                    'POSIX_MEM_ALIGNMENT', 'POSIX_FILE_ALIGNMENT', 'NPROCS', 'POSIX_TOTAL_ACCESSES',
                    'POSIX_TOTAL_BYTES',
                    'POSIX_TOTAL_FILES']
...
def extracting_perc1(path):
    ...
    perc_features1 = [
        ...
        'POSIX_READ_ONLY_BYTES', 'POSIX_READ_WRITE_BYTES',
        'POSIX_WRITE_ONLY_BYTES', 'POSIX_UNIQUE_FILES',
        'POSIX_SHARED_FILES', 'POSIX_READ_ONLY_FILES',
        ...
        'POSIX_MEM_NOT_ALIGNED', 'POSIX_ACCESS1_COUNT',
